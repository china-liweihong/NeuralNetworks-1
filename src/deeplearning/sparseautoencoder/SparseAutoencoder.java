...
public class SparseAutoencoder implements deeplearning.minimizers.Network {
	//8*8 = 64 input pixels
	...
	public SparseAutoencoder(int visibleSize, int hiddenSize, double lambda,
	...
	public static CostGradient nnCostFunction(DoubleMatrix nnParams,
		...
		sn[sn.length - 1] = h.sub(X).mul(Activations.sigmoidGradient(z[z.length-1]));
